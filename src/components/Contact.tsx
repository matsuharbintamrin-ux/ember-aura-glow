      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Kami siap melayani kebutuhan arang dan briket Anda. Hubungi kami untuk konsultasi 
          ...
          {contactInfo.map((contact, index) => (
            <Card key={index} className="group hover:shadow-lg transition-all duration-300">
              <CardContent className="p-6 text-center">
                <div className={`inline-flex items-center justify-center w-14 h-14 rounded-full bg-${contact.color}/10 text-${contact.color} mb-4 group-hover:scale-110 transition-transform duration-300`}>
                  {contact.icon}
                </div>
                ...
                <p className="text-sm text-muted-foreground mt-1">{contact.subInfo}</p>
              </CardContent>
            </Card>
          ))}
        </div>
            ...
            <CardContent className="p-8 md:p-12">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">
                  Dapatkan penawaran terbaik dan konsultasi gratis untuk kebutuhan bisnis Anda
                </p>
              </div>
              ...
              <div className="mt-8 pt-8 border-t text-center">
                <p className="text-sm text-muted-foreground">
                  <span className="font-semibold text-foreground">Pengiriman ke seluruh Indonesia</span> 
